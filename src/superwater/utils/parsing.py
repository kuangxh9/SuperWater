...
def parse_train_args(argv=None):
    ...
    parser.add_argument('--log_dir', type=str, default='models', help='Folder in which to save model and logs')
    ...
    parser.add_argument('--split_train', type=str, default='examples/data/splits/train_res15.txt', help='Path of file defining the split')
    parser.add_argument('--split_val', type=str, default='examples/data/splits/val_res15.txt', help='Path of file defining the split')
    parser.add_argument('--split_test', type=str, default='examples/data/splits/test_res15.txt', help='Path of file defining the split')
...
def parse_confidence_args(argv=None):
    # General arguments
    parser = ArgumentParser()
    parser.add_argument('--config', type=FileType(mode='r'), default=None)
    parser.add_argument('--original_model_dir', type=str, default='models', help='Path to folder with trained model and hyperparameters')
    ...
    parser.add_argument('--log_dir', type=str, default='models', help='')
...
def parse_inference_args(argv=None):
    ...
    parser = ArgumentParser()
    parser.add_argument('--config', type=FileType(mode='r'), default=None)
    parser.add_argument('--original_model_dir', type=str, default='models',
                        help='Path to folder with trained model and hyperparameters')
    parser.add_argument('--confidence_dir', type=str, default='models',
    ...
    parser.add_argument('--log_dir', type=str, default='outputs', help='')
    ...
    parser.add_argument('--save_pos', action='store_true', default=False, help='Save predicted water positions to disk')
    parser.add_argument('--save_pos_path', type=str, default=None,
                        help='Name of the sub-folder under outputs/ for predictions. '
                             'If None, defaults to inferenced_pos_rr<ratio>_cap<cap>.')
    parser.add_argument('--output_format', type=str, default='pdb', choices=['pdb', 'cif'],
                        help='Format for the saved water centroid structure file.')
