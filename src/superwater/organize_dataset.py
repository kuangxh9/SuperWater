...
def parse_args(argv=None):
    ...
    parser.add_argument("--dummy_water_dir", type=str, default=None,
                        help="Directory containing _water.{pdb,mol2} template files (defaults to the packaged copy).")
    parser.add_argument("--logs_dir", type=str, default="outputs/logs", help="Directory to save logs.")
...
def main():
    ...
    dummy_water_path = args.dummy_water_dir or DUMMY_WATER_DIR
    ...
    print(f"Successfully saved test PDB IDs to {split_file_path}.")
