...
def parse_train_args():
    ...
    parser.add_argument('--data_dir', type=str, default='data/cleaned_metal_protein/', help='Folder containing original structures')
    ...
    parser.add_argument('--split_val', type=str, default='data/splits/timesplit_no_lig_overlap_val_large', help='Path of file defining the split')
    ...
    parser.add_argument('--project', type=str, default='difwater_train', help='')
